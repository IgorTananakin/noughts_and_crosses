...
let field = ["", "", "", "", "", "", "", "", ""];//поле
let isGameActive = false;//можем ходить или нет
let symbol = null;
let turn = null;

let ws = new WebSocket("ws://localhost:8080");//установить соеденения с websocket
...
ws.onmessage = message => {
  ...
  if (response.method === "update") {
    ...
    turn = response.turn;
    isGameActive = symbol === turn;//игра активна если символ равен очереди игрока
    updateBoard();
    updateMessage();
  }
